...
app.config["TOKEN"] = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoibWFraW5hIn0.jUTxi6c2-o3nH\
J6Bq7zRXFoKixUyYetgPX3cToOayiA"
...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        ...
        if not token and (not auth or auth.username != "makina" or auth.password != "makina"):
